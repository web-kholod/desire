 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper, .swiper-small, .swiper-artical")) {
                new core(".swiper", {
                ...
                new core(".swiper-artical", {
                    ...
                    effect: "fade",
                    navigation: {
                        prevEl: ".artical-button-prev",
                        nextEl: ".artical-button-next"
                    },
                    on: {}
                });
            }
